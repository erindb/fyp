...
We compared the performance of human participants on their version of the task to the performance of a script induction model implemented by \citeA{rudinger2015learning}.
...
The script induction models tested by \citeA{rudinger2015learning} had access to only a small amount of linguistic information in the narrative cloze test, since each event was reduced to a single verb and the syntactic role of the protagonist.
...
%The additional linguistic information in the sentences 
%It is possible that other more complex models could leverage be tested on narrative cloze tasks with more linguistic information.
...
In a second condition, somewhat resembling the structure of the narrative cloze task used by \citeA{pichotta2014statistical}, we provided people with a ``caveman-speak'' version of the sentence.
