...
We compare the human data to the single-entity event chain model of \citeA{chambers2008unsupervised}. In this model \todo{insert math here}.
...
\todo{people don't agree with one another}
...
\begin{figure}
 ...
 \caption{The model does not appear to increase in its ability to recover at least one synonym of the humans' responses as agreement between participants increases.}
